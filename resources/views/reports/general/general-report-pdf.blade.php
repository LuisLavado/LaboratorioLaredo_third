...
<head>
    ...
    <title>{{ $title ?? 'Reporte General de Laboratorio' }}</title>
    <style>
        body {
...
<body>
    <div class="header">
        <h1>{{ $title ?? 'Reporte General de Laboratorio' }}</h1>
        <div class="subtitle">Análisis Completo del Laboratorio</div>
        <div class="subtitle">
    ...
    <div class="section">
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td>{{ $exam->codigo ?? $exam->id ?? 'N/A' }}</td>
                    <td>{{ $exam->nombre ?? $exam->name ?? 'Sin nombre' }}</td>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">{{ $day->patientCount ?? 0 }}</td>
                    <td class="text-center">{{ $day->examCount ?? 0 }}</td>
                </tr>
                @endforeach
            </tbody>
        </table>
    ...
    <div class="footer">
        <p>Reporte General del Sistema de Laboratorio</p>
