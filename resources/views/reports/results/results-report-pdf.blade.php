...
<head>
    ...
    <title>{{ $title ?? 'Reporte de Resultados' }}</title>
    <style>
        body {
...
<body>
    <div class="header">
        <h1>{{ $title ?? 'Reporte de Resultados' }}</h1>
        <div class="subtitle">Análisis de Resultados de Exámenes</div>
        <div class="subtitle">
    ...
    <div class="section">
        <h2 class="section-title">Distribución de Estados</h2>
        <table>
            <thead>
                <tr>
                    <th>Estado</th>
    ...
    <div class="section">
        <h2 class="section-title">Tiempos de Procesamiento</h2>
        <table>
            <thead>
                <tr>
            ...
            <tbody>
                ...
                <tr>
                    <td>{{ $stat->exam_name ?? 'Sin nombre' }}</td>
                    <td class="text-center">{{ $stat->avg_time ?? 'N/A' }}</td>
    ...
    <div class="section">
        <h2 class="section-title">Actividad Diaria de Resultados</h2>
        <table>
            <thead>
                <tr>
                    <th>Fecha</th>
            ...
            <tbody>
                ...
                <tr>
                    <td>{{ $day->date ?? $day->fecha ?? 'N/A' }}</td>
                    <td class="text-center">{{ $day->completed ?? 0 }}</td>
                    <td class="text-center">{{ $day->pending ?? 0 }}</td>
                    <td class="text-center">{{ ($day->completed ?? 0) + ($day->pending ?? 0) }}</td>
                </tr>
                @endforeach
            </tbody>
        </table>
    ...
    <div class="footer">
        <p>Reporte de Resultados del Sistema de Laboratorio</p>
