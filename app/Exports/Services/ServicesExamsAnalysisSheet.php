...
/**
 * Hoja de Análisis por Exámenes - Servicios (Independiente)
 */
class ServicesExamsAnalysisSheet implements FromArray, WithHeadings, WithStyles, WithTitle, WithColumnWidths
{
    protected $data;
    protected $startDate;
    protected $endDate;
    ...
    public function array(): array
    {
        ...
        foreach ($servicios as $servicio) {
            ...
            foreach ($rangos as $nombreRango => $rango) {
                if ($examenes >= $rango['min'] && $examenes <= $rango['max']) {
                    ...
                    $grupos[$nombreRango]['ingresos'] += $ingresos;
        ...
        foreach ($grupos as $nombreRango => $grupo) {
            ...
            $promedioIngresos = $grupo['count'] > 0 ? round($grupo['ingresos'] / $grupo['count'], 2) : 0;
            ...
            } elseif ($promedioIngresos > 1000) {
                $recomendacion = 'Alto valor';
            }
    ...
    public function columnWidths(): array
    {
        return [
            ...
            'E' => 18,  // Ingresos Totales
            'F' => 15,  // Ingreso Promedio
            'G' => 30,  // Servicios Populares
            'H' => 12,  // Participación
            'I' => 12,  // Eficiencia
            'J' => 18,  // Recomendación
        ];
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        if ($lastRow > 1) {
            ...
            $sheet->getStyle("H2:I{$lastRow}")->getAlignment()->setHorizontal(Alignment::HORIZONTAL_RIGHT); // Porcentajes
            $sheet->getStyle("J2:J{$lastRow}")->getAlignment()->setHorizontal(Alignment::HORIZONTAL_CENTER); // Recomendación
