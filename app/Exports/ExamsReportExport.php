...
class ExamsReportExport implements WithMultipleSheets, WithTitle
{
    ...
    public function sheets(): array
    {
        ...
        $sheets[] = new ExamsStatsSummarySheet($this->data, $this->startDate, $this->endDate);

        // Hoja 2: Listado Detallado de Exámenes
        $sheets[] = new ExamsDetailedListSheet($this->data, $this->startDate, $this->endDate);

        // Hoja 3: Exámenes por Categoría
        $sheets[] = new ExamsByCategorySheet($this->data, $this->startDate, $this->endDate);

        // Hoja 4: Exámenes por Estado
        $sheets[] = new ExamsByStatusSheet($this->data, $this->startDate, $this->endDate);

        // Hoja 5: Análisis de Rendimiento
        $sheets[] = new ExamsPerformanceSheet($this->data, $this->startDate, $this->endDate);
