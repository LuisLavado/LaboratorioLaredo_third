...
class AdvancedStatsSheet implements FromArray, WithHeadings, WithTitle, WithStyles, WithColumnWidths
{
    ...
    public function headings(): array
    {
        return [
            ...
            [],
            ['SECCIÓN', 'MÉTRICA', 'VALOR', 'PORCENTAJE', 'TENDENCIA']
        ];
    }
    ...
    public function array(): array
    {
        ...
        $rows[] = ['', 'Pacientes recurrentes', $this->getRecurrentPatientsCount(), $this->getRecurrentPatientsPercentage(), '→'];
        ...
        $rows[] = ['', 'Tiempo promedio procesamiento', $this->getAverageProcessingTime(), '', '↓'];
